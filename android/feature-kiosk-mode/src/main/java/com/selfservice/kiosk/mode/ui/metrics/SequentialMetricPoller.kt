...
import com.selfservice.kiosk.mode.data.db.OBDCombinedReading
import com.selfservice.kiosk.mode.data.db.OBDDataType
import com.selfservice.kiosk.mode.data.db.OBDLogDao
import com.selfservice.kiosk.mode.data.preferences.AppPreferences
...
class SequentialMetricPoller(
    ...
    private val errorMessage: MutableSharedFlow<String>
) {
