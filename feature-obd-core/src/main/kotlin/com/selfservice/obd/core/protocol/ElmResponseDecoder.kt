...
object ElmResponseDecoder {
    ...
    fun parseDtc(frame: TransportFrame, manufacturer: String? = null): ObdDtcBatch? {
        return parseDtc(asciiString(frame), frame.timestampMs, manufacturer)
    }
    ...
    fun parseDtc(
        ...
        while (pointer + 1 < data.size) {
            ...
            val definition = dictionaries.lookupDtcWithManufacturerFallback(code, manufacturer)
