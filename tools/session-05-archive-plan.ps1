...
$targets = @(
    ...
    [pscustomobject]@{ Source = "android/kiosk-frontend"; Destination = "archives/10-tools/01-interfaces/third-party/kiosk-frontend"; Category = "third-party" },
    [pscustomobject]@{ Source = "android/Bluetooth-OBD-II-Diagnostic-Tool-main"; Destination = "archives/10-tools/01-interfaces/third-party/Bluetooth-OBD-II-Diagnostic-Tool-main"; Category = "third-party" },
    [pscustomobject]@{ Source = "android/android-obd-reader-master"; Destination = "archives/10-tools/01-interfaces/third-party/android-obd-reader-master"; Category = "third-party" },
    [pscustomobject]@{ Source = "blessed-kotlin-main"; Destination = "archives/10-tools/01-interfaces/third-party/blessed-kotlin-main"; Category = "third-party" },
    [pscustomobject]@{ Source = "compose-multiplatform-master"; Destination = "archives/10-tools/01-interfaces/third-party/compose-multiplatform-master"; Category = "third-party" },
    [pscustomobject]@{ Source = "KasirPraktis-master"; Destination = "archives/10-tools/01-interfaces/third-party/KasirPraktis-master"; Category = "third-party" },
    [pscustomobject]@{ Source = "Kiosk-Launcher-main"; Destination = "archives/10-tools/01-interfaces/third-party/Kiosk-Launcher-main"; Category = "third-party" },
    [pscustomobject]@{ Source = "obd-master"; Destination = "archives/10-tools/01-interfaces/third-party/obd-master"; Category = "third-party" },
    [pscustomobject]@{ Source = "yookassa-android-sdk-master"; Destination = "archives/10-tools/01-interfaces/third-party/yookassa-android-sdk-master"; Category = "third-party" },
    [pscustomobject]@{ Source = "qrcode-kotlin-main"; Destination = "archives/10-tools/01-interfaces/third-party/qrcode-kotlin-main"; Category = "third-party" }
)
