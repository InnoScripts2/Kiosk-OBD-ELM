/**
 * @typedef {Object} RealtimeChartOptions
 * @property {number=} maxDataPoints
 * @property {number=} updateInterval
 */

/**
 * @typedef {Record<string, number> & { timestamp: number }} MetricPoint
 */

/** @type {Record<string, { color: string; scale: number; label: string }>} */
...
export class RealtimeChart {
   ...
   * @param {RealtimeChartOptions} [options]
   */
