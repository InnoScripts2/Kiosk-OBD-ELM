...
/**
 * @typedef {Object} HybridMotor
 * @property {number=} speed
 * @property {number=} torque
 */

/**
 * @typedef {Object} HybridSystemData
 * @property {HybridBattery=} hvBattery
 * @property {{ temp?: number }=} inverter
 * @property {HybridMotor=} mg1
 * @property {HybridMotor=} mg2
 */
...
export class HybridPanel {
  ...
  /**
   * @param {HybridSystemData | null} data
   * @returns {void}
   */
  update(data) {
  ...
  /**
   * @param {HybridMotor | undefined} mg1
   * @param {HybridMotor | undefined} mg2
   * @returns {HTMLDivElement}
   */
